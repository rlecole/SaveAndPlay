...
namespace SaveAndPlay.AudioPlaybackAgent
{
    public class AudioPlayer : AudioPlayerAgent
    {
        private static volatile bool _classInitialized;

        public static List<AudioTrack> Tracks { get; set; }
        private static int TrackIndex = -1;
        private static int ConsecutiveFileNotFoundErrorCount = 0;
        ...
        public AudioPlayer()
        {
            if (!_classInitialized)
            {
                ...
                Tracks = new PlaybackAgentDataService().GetPlaylist();
