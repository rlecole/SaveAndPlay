...
namespace SaveAndPlay.UI.Pages
{
    public partial class PlaylistPage : BasePage
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            App.DataCacheServiceInstance.Register((PlaylistViewModel)this.DataContext);
        }

        protected override void OnNavigatedFrom(NavigationEventArgs e)
        {
            base.OnNavigatedFrom(e);
            App.DataCacheServiceInstance.Unregister((PlaylistViewModel)this.DataContext);
            this.progressOverlay.Visibility = System.Windows.Visibility.Visible;
            ((PlaylistViewModel)this.DataContext).Unload();
        }
        ...
        private void ListBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                ((PlaylistViewModel)this.DataContext).SelectedSong = (AudioMedia)this.ListBox.SelectedItem;
        ...
        {
            ((PlaylistViewModel)this.DataContext).Save(this.PlaylistTextBox.Text);
        }
        ...
        {
            ((PlaylistViewModel)this.DataContext).Delete();
        }
    }
}